...
import unittest
from workday_counter import _get_country_name_for_region, _get_num_of_workdays_of_a_country, get_num_of_workdays
...
class TestWorkdayCounter(unittest.TestCase):
	...
	def test_get_num_of_workdays_of_a_country(self):
		#GIVEN
		#WHEN
		actual_ln_workdays_2022_04 = _get_num_of_workdays_of_a_country('UnitedKingdom', 4, 2022)
		actual_hk_workdays_2022_02 = _get_num_of_workdays_of_a_country('HongKong', 2, 2022)
		actual_tk_workdays_2021_04 = _get_num_of_workdays_of_a_country('Japan', 4, 2021)
		actual_ny_workdays_2020_07 = _get_num_of_workdays_of_a_country('UnitedStates', 7, 2020)
	...
	def test_get_num_of_workdays(self):
		#GIVEN
		#WHEN
		actual_hk_workdays_2022_04 = get_num_of_workdays('hk', month=4, year=2022)
		actual_ny_workdays_2022_04 = get_num_of_workdays('ny', month=4, year=2022)
		actual_ln_workdays_2022_04 = get_num_of_workdays('ln', month=4, year=2022)
		actual_tk_workdays_2022_04 = get_num_of_workdays('tk', month=4, year=2022)
		the_smallest_num_of_workdays_amongst_regions = get_num_of_workdays(month=4, year=2022)
